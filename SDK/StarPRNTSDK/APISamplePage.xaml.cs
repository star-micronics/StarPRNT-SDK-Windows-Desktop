...
namespace StarPRNTSDK
{
    public static class APIFunctionManager
    {
        ...
        private static byte[] CreateAPICommands(APIManager.APIType type)
        {
            ...
            // Your printer model.
            PrinterModel printerModel = SharedInformationManager.SelectedModelInformation.Model;
            ...
            switch (type)
            {
                ...
                case APIManager.APIType.Label:
                    // Select label type.
                    LabelType? labelType = ShowSelectLabelTypeWindow();
                    ...
                    commands = APIFunctions.CreateLabelData(emulation, (LabelType)labelType);
                    break;
            }
        ...
        private static LabelType? ShowSelectLabelTypeWindow()
        {
            LabelType? labelType = null;

            SelectSettingWindow selectLabelWindow = new SelectSettingWindow(SelectSettingWindow.Templete.LabelType);

            bool? result = selectLabelWindow.ShowDialog();

            if (result == true)
            {
                labelType = selectLabelWindow.SelectedLabelType;
            }
            else
            {
                return null;
