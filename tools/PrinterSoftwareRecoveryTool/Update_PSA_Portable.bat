...
PrinterSoftwareRecoveryToolConsole /q /portable
...
if %ERRORLEVEL%==3 set message=Updating software is not needed.
...
if %ERRORLEVEL%==5 set message=Updating software is failed. Please try again.
